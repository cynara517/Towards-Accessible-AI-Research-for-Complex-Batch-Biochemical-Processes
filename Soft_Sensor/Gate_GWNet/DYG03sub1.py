...
DATA_NAME = 'DYG_data_3_sub1-3'  # Dataset name
...
adj_mx, _ = load_adj("/home/home_new/qsmx/pycodes/BasicTS/datasets/" + DATA_NAME +
                     "/predicted_adj_matrix_1.pkl", "doubletransition")
MODEL_PARAM = {
    "num_nodes": 5,
